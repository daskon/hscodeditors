...
$sql2 = "SELECT package.pack_name FROM package INNER JOIN user ON package.pack_id = user.pack_id WHERE user.pack_id";

$result = $con->query($sql);
$result2 = $con->query($sql2);


while ($fetch = mysqli_fetch_assoc($result) and $fetch2 = mysqli_fetch_assoc($result2)) {
    echo "<tr><td>".$fetch2['pack_name'] . "</td>
    <td>". $fetch['user_name'] ."</td>
    <td>". $fetch['user_email'] ."</td>
    <td>". $fetch['user_password'] ."</td></tr>";
