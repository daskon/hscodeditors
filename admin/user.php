...
$sql2 = "SELECT package.pack_name, package.validity, package.price FROM package INNER JOIN user ON package.pack_id = user.pack_id WHERE user.pack_id";
...
while ($fetch = mysqli_fetch_assoc($result) and $fetch2 = mysqli_fetch_assoc($result2)) {
    ...
    <td>". $fetch2['validity'] ."</td>
    <td>Rs.". $fetch2['price'] ."</td>
    <!--<td>". md5($fetch['user_password']) ."</td></tr>-->";
