...
$sql = "SELECT v.vendor_name, v.vendor_email, c.cat_name, st.type_name, s.service_name
        FROM vendor v , service_category c, service_type st, services s, task t
