...
$sql2 = "SELECT user.user_name FROM user INNER JOIN wallet ON user.user_id = wallet.user_id WHERE wallet.user_id";
...
while ($fetch = mysqli_fetch_assoc($result) and $fetch2 = mysqli_fetch_assoc($result2)) {
	echo "<tr><td>".$fetch2['user_name'] . "</td>
	<td>". $fetch['points'] ."</td>
	<td>". $fetch['balance'] ."</td></tr>";
